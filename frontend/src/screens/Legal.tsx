...
const PRIVACY: Section[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Email opens — campaign emails include an invisible 1-pixel tracking image that records when a recipient opened the email (first open time and a count of distinct opens). Repeat views of the same message and the sender's own copy do not inflate the count. Nothing else about the recipient is collected, and the image is served by us, not a third party.",
